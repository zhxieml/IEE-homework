...
<div class="wrapper">
    <dl>
            ...
            <dt class="redf39" >Hi~<a class="redf39 nav-tl" href="javascript:void(0);" id="logBtn" target="_blank">欢迎登录<span class="icon-arrowB ml5"></span></a>
      
      <!--  
        <div class="backstage">
          <h6>产品投放后台</h6>          
          <div class="no-open" style="display:block">
            <p>快来体验我们的产品吧！</p>
            <p>使用过的产品会在这里展示。</p>
            <a href="" id="logBtn">点此继续完善账号信息</a>
          </div>          
        </div>
       --> 
        
      </dt>      
      <dt style="display:block" ><a href="//jzt.jd.com"  class="nav-tl" id="logBtn1">立即入驻</a></dt>
      
      
      <dd><a href="//xjzt.jd.com/charging/index.jhtml" class="nav-tr" target="_blank">帮助中心</a></dd>
      <dd>
      ...
      <dd><a href="//xjzt.jd.com" target="_blank" class="nav-tr">在线学习</a></dd>
  ...
  <!-- END nav -->
    ...
    <div class="pushBox"  id="loginPush">
    <div class="msk-bg"></div>
    <div class="loginBox">
    <span class="pb-close"></span>
        <h3 class="pb-tit">登录京东账户</h3>
        <a href="//reg.jd.com/reg/person?ReturnUrl=https%3A%2F%2Fjzt.jd.com%2F" target="_blank" class="link-reg">我要注册&gt;</a>
            <iframe src="//passport.jd.com/common/loginPage?from=jzt&ReturnUrl=http://jzt.jd.com/" style="width:360px;height: 260px;" scrolling="no" frameborder="0">
            </iframe>
    </div>
   </div>
 <input name="returnurl_name" type="hidden" id="returnurl_id" readonly="readonly" value="http://jzt.jd.com/">
 <input name="pin_name" type="hidden" id="pin_id" readonly="readonly" value="">
 <script>
 $(function(){

 return_url = $("#returnurl_id").val();
 pin_name= $("#pin_id").val();
 if(return_url.indexOf("/jzt.jd.com/gw/") > -1){  //如果不是这两个就要求弹窗	 
 }else if(return_url.indexOf("/jzt.jd.com/gw/") <= -1 && (pin_name == '' || pin_name==null)){
...
<div class="wrapper-head relative">
	<div class="wrapper-con hidden">
		...
		<h1>
		<a class="logo" href="//jzt.jd.com/gw/" target="_blank" title="CPS广告_CPS广告_CPM广告_京东广告投放平台" alt="CPS广告_CPS广告_CPM广告_京东广告投放平台"><img src="/gw/r/cms/www/www_new/img/logo.jpg"></a></h1>
...
<div class="slide-tu">
      <ul>
                           <li>
                       <a href="https://xjzt.jd.com/monthly/1682.jhtml" style="background:url(http://storage.jd.com/jtz.file.cloudy/201809/211823035rt2.png) no-repeat center;"></a>
                   </li>
                   <li>
                       <a href="https://xjzt.jd.com/dissertation/1312.jhtml" style="background:url(http://storage.jd.com/jtz.file.cloudy/201708/31114028vlmp.jpg) no-repeat center;"></a>
                   </li>
                   <li>
                       <a href="https://jzt.jd.com/gw/kcenter/html/home.html" style="background:url(http://storage.jd.com/jtz.file.cloudy/201707/111922531tnp.jpg) no-repeat center;"></a>
                   </li>
      </ul>
</div>
	...
	<div class="wrapper pb70">
		...
		<div class="wrapper-nei pt10 pb10">
			<div class="csae-main-box" id="scrollCon1">
				...
				<div class="list-video">
					<a href="https://jzt.jd.com/gw/jdztexample/1556.html" class="module-video">
						<img src="http://storage.jd.com/jtz.file.cloudy/201806/01135441ajnt.jpg">
						<p class="video-title">好奇品牌日-京东直投优秀案例<span>→</span></p>
						<p class="video-detail">超级品牌日通过京腾渠道站外引流，打造精准效果营销。</p>
					</a>
				</div>
...
<div class="module-navbar">
	<a href="javascript:void(0)" target="_blank">
		...
		<div class="phone">
			<p>京准通 APP 上线啦</p>
			<img src="/gw/r/cms/www/www_new/img/jzt-ios.png">
			<p>下载 iPhone 版</p>
			<img src="/gw/r/cms/www/www_new/img/jzt-android.png">
			<p>下载 Android 版</p>
		</div>
	</a>
    ...
    <div class="footer-con">
      <div class="clearfix">
        <div class="footer-nav">
          ...
          <dl>
            <dt>在线学习</dt>
            <dd><a href="//xjzt.jd.com/jingzhuntong/index.jhtml" target="_blank">自学教程</a></dd>
            <dd><a href="//xjzt.jd.com/online/index.jhtml" target="_blank">京点书院</a></dd>
            <dd><a href="//xjzt.jd.com/charging/index.jhtml" target="_blank">常见问题</a></dd>
          ...
          <dl>
            ...
            <dd><a href="//zt.jd.com/edu/edu_home.shtml" target="_blank">京东直投</a></dd>

...
<link rel="shortcut icon" href="//img.alicdn.com/favicon.ico" type="image/x-icon" />	
		...
		<link type="text/css" href="//g.alicdn.com/sd/ncpc/nc.css?t=2018102020" rel="stylesheet" />
...
with(document)with(body)with(insertBefore(createElement("script"),firstChild))setAttribute("exparams","category=&userid=&aplus&yunid=&&trid=0bb080ce15400371749258724e0c3e&asid=AQAAAAA2GstbQF/qXAAAAADgwbsvtL9yjQ==",id="tb-beacon-aplus",src=(location>"https"?"//g":"//g")+".alicdn.com/alilog/mlog/aplus_v2.js")
</script>
...
<div class="logo">
    ...
    <div class="login-newbg"  style="background-image: url(https://img.alicdn.com/tfs/TB15oDiiQzoK1RjSZFlXXai4VXa-2500-600.jpg);height:600px;">
    ...
    <div class="login-adlink">
        <a href="https:&#x2F;&#x2F;pages.tmall.com&#x2F;wow&#x2F;a&#x2F;act&#x2F;20548&#x2F;upr?wh_pid=main-153366&amp;wh_weex=true&amp;wh_biz=tm" target="_blank" onclick="javascript:goldlog.record('/member.11.2','','','H46777405')"></a>
    </div>
...
<div class="bd">
		...
		<div class="static-form " id="J_StaticForm">
			...
			<form action="/member/login.jhtml?redirectURL=https%3A%2F%2Fmyseller.taobao.com%2Fseller_admin.htm"  method="post" id="J_Form">
		    <div id="J_Message"
				style="display:none;"
			...
			<div class="submit">
				...
				<input id="J_NcoToken" type="hidden" name="ncoToken"
					value="aa65a56bf421ff81b05941eaea8851e5fa826963" />
				...
				<input type="hidden" id="J_TPL_redirect_url" name="TPL_redirect_url"
					value="https://myseller.taobao.com/seller_admin.htm" />
				...
				<input type="hidden" name="mobileLoginLink" value="https://login.taobao.com/member/login.jhtml?from=taobaoindex&amp;f=top&amp;style=&amp;sub=true&amp;redirect_url=https://myseller.taobao.com/seller_admin.htm&amp;useMobile=true" />
			...
			<ul class="entries">
				<li id="J_OtherLogin" class="other-login">
								...
								<a href="http://weibo.com/login.php?entry=taobao&goto=https%3A%2F%2Flogin.taobao.com%2Faso%2Ftvs%3Fdomain%3Dweibo%26sid%3D52cf98d1b82ee380c5bb9bd932ac1ac1%26target%3D68747470733A2F2F6D7973656C6C65722E74616F62616F2E636F6D2F73656C6C65725F61646D696E2E68746D&goto2=https%3A%2F%2Fmyseller.taobao.com%2Fseller_admin.htm" tabindex="4" class="weibo-login"><i class="iconfont">&#xe603;</i>微博登录</a>
							 
								<a href="https://auth.alipay.com/login/index.htm?loginScene=7&goto=https%3A%2F%2Fauth.alipay.com%2Flogin%2Ftaobao_trust_login.htm%3Ftarget%3Dhttps%253A%252F%252Flogin.taobao.com%252Fmember%252Falipay_sign_dispatcher.jhtml%253Ftg%253Dhttps%25253A%25252F%25252Fmyseller.taobao.com%25252Fseller_admin.htm&params=VFBMX3JlZGlyZWN0X3VybD1odHRwcyUzQSUyRiUyRm15c2VsbGVyLnRhb2Jhby5jb20lMkZzZWxsZXJfYWRtaW4uaHRt" tabindex="5" class="alipay-login"><i class="iconfont">&#xe618;</i>支付宝登录</a> 
			...
			<div class="login-links">
				...
				<a href="https://passport.taobao.com/ac/password_find.htm?from_site=0&login_id=&lang=zh_CN&app_name=taobaoindex&tracelog=signin_main_pass" tabindex="6" class="forget-pwd" target="_blank">
					忘记密码</a>
...
<!-- #footer END -->
<div id="server-num">login011130216176.na62</div>
...
<script type="text/javascript" charset="utf-8" src="//g.alicdn.com/sd/ncpc/nc.js?t=2018102020"></script>
  ...
  function initNC() {
		var nc = new noCaptcha();
			var opt = {
				...
				token : "aa65a56bf421ff81b05941eaea8851e5fa826963",

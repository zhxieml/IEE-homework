...
UaqsGh0seegE/k+AOd8Pbzum1FTIg6ySqHhVQDFmYI8CAwEAAQ==" />
                        <input name="ReturnUrl" type="hidden" value="https://p.joybuy.com/user/initBasicInfo.do" />
...
<!--                            <div class="social-link-list" >
                            ...
                            <div class="social-link-list">
                                <a class="icon-facebook" href="javascript:login4FacebookUnion(&#39;https://p.joybuy.com/user/initBasicInfo.do&#39;);" tabindex="4"></a>
                                <a class="icon-google" href="javascript:login4GoogleUnion(&#39;https://p.joybuy.com/user/initBasicInfo.do&#39;);" tabindex="5"></a>
                                <a class="icon-twitter" href="javascript:login4TwitterUnion(&#39;https://p.joybuy.com/user/initBasicInfo.do&#39;);" tabindex="6"></a>
                                <a class="icon-pinterest icon-hide" href="javascript:login4PinterestUnion(&#39;https://p.joybuy.com/user/initBasicInfo.do&#39;);" tabindex="7"></a>
                                <a class="icon-vk icon-hide" href="javascript:login4VkUnion(&#39;https://p.joybuy.com/user/initBasicInfo.do&#39;);" tabindex="8"></a>
                                <a class="icon-ok icon-hide" href="javascript:login4OkUnion(&#39;https://p.joybuy.com/user/initBasicInfo.do&#39;);" tabindex="9"></a>
